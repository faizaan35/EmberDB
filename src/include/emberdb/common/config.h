...
// Version constants
constexpr std::string_view EMBERDB_VERSION = "0.1.0";
constexpr int EMBERDB_VERSION_MAJOR = 0;
constexpr int EMBERDB_VERSION_MINOR = 1;
constexpr int EMBERDB_VERSION_PATCH = 0;
